...
int main(int argc, char **argv)
{
  ...
  // Testing deleteList when the list only has 1 element (edge case).
  printf("Delete list tests follow.\n");
  ...
  // Test deleting on empty list
  deleteList(L, 0);
  printf("Deleted on empty list without segfault.\n");
}